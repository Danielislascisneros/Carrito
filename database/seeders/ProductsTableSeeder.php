...
class ProductsTableSeeder extends Seeder
{
    ...
    {   //Productos para caballero
        ...
        Product::create([
            ...
            'slug' => 'Audifonos Gamer IPX8 ',
            'details' => 'Impermerable, Reduce el Ruido CVC8.0, Sonido Estéreo con Baja Latencia Auriculares para Juegos,Escuchar Música, Llamar, Ver El Vídeo',
            'price' => 279.00,
            'shipping_cost' => 12.59,
            'description' => 'Audifonos Gamer IPX8',
            'category_id' => 4,
            'brand_id' => 4,
            'image_path' => 'ventas1.png'
        ]);
        ...
        Product::create([
            'name' => 'Zapatillas',
            'slug' => 'Frida Kolection',
            'details' => 'TALLA 23-26',
            'price' => 379,
            'shipping_cost' => 379,
            'description' => 'Frida Kolection',
            'category_id' => 1,
            'brand_id' => 1,
            'image_path' => 'ventas1mujer.png'
        ]);
    }
}
